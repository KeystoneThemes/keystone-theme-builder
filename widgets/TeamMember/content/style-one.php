...
<div class="stonex-team-item style-one">
...
<div <?php echo $this->get_render_attribute_string( 'stonex_team_member_item' ); ?>>
    ...
    <div class="stonex-team-member-content">
        ...
        <?php
            ...
            if ( 'yes' == $settings['stonex_show_remark'] ) : ?>
        ...
        <div class="member-remark">
            ...
            <?php if ( 'yes' === $settings['stonex_section_team_members_cta_btn'] ) : ?>
...
<?php
        ...
        <?php do_action('stonex_team_member_content_area_after'); ?>
