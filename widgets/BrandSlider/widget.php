...
class Scalo_Brand_Carousel extends Widget_Base
{
    ...
    public function get_name()
    {
        ...
        return 'stonex-brand-carousel';
    }

    public function get_title()
    {

        return esc_html__('Brand Carousel', 'stonex');
    }
    ...
    protected function genarel_section_info()
    {
        ...
        $this->add_control(
            'title_tag',
            [
                'label' => __('Title HTML Tag', 'stonex'),
    ...
    protected function genarel_section_settings()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'max' => 10000,
                'default' => 800,
                'description' => __('Slide speed in milliseconds', 'stonex'),
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label' => __('Autoplay Speed', 'stonex'),
                'type' => Controls_Manager::NUMBER,
                'min' => 100,
                'step' => 100,
                'max' => 10000,
                'default' => 2000,
                'description' => __('Autoplay speed in milliseconds', 'stonex'),
                'condition' => [
                    'autoplay' => 'yes'
                ],
                'frontend_available' => true,
        ...
        $this->add_control(
            'center',
            [
                'label' => __('Center Mode?', 'stonex'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'stonex'),
                'label_off' => __('No', 'stonex'),
                'return_value' => 'yes',
                'description' => __('Best works with odd number of slides (Slides To Show) and loop (Infinite Loop)', 'stonex'),
                'frontend_available' => true,
                'style_transfer' => true,
            ]
        );
        ...
        $this->add_control(
            'navigation',
            [
                'label' => __('Enable Navigation', 'stonex'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'stonex'),
                'label_off' => __('No', 'stonex'),
                'return_value' => 'yes',
     ...
     *careousel_section_style_item
     * @return void
     */
    protected function careousel_section_style_item()
    {
        $this->start_controls_section(
            'carousel_section_style_item',
            [
                'label' => __('Carousel Item', 'stonex'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-figure' => 'text-align: {{VALUE}}'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-carousel-item' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'item_spacing',
            [
                'label' => __('Space Between items', 'stonex'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    '%' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .brand-slick-slide' => 'padding: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-carousel-item' => 'padding: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'item_border',
                'selector' => '{{WRAPPER}} .stonex-brand-carousel-item'
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-carousel-item' => 'border-radius: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .stonex-brand-figure img' => 'border-top-left-radius: {{SIZE}}{{UNIT}}; border-top-right-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function brand_section_style_image()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Display', 'stonex'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'solid',
                'options' => [
                    'block'  => esc_html__('Block', 'stonex'),
                    'inline-block' => esc_html__('Inline-block', 'stonex'),
                    'flex' => esc_html__('Flex', 'stonex'),
                    'none' => esc_html__('None', 'stonex'),
                ],
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-figure img' => 'display: {{VALUE}}'
                ]
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-figure' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-figure' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-figure' => 'margin-bottom: {{SIZE}}{{UNIT}} !important;',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-figure > img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'image_border',
                'selector' => '{{WRAPPER}} .stonex-brand-figure > img'
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-figure > img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
...
*/
    ...
    /**
     * Undocumented function
     *brand_section_style_content_box
     * @return void
     */
    protected function brand_section_style_content_box()
    {
        $this->start_controls_section(
            '_section_style_content_box',
            [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-body' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-body' => 'padding: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .stonex-brand-body'
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .stonex-brand-body' => 'border-radius: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .stonex-brand-figure img' => 'border-top-left-radius: {{SIZE}}{{UNIT}}; border-top-right-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('brand_version', 'class', 'stonex-brand-carousel-wrap');
        ...
        <div <?php echo $this->get_render_attribute_string('brand_version'); ?>>
            ...
            ?>
                <div class="brand-slick-slide">
                    <div class="stonex-brand-carousel-item">

                        <?php if ($brand['image']) : ?>
                            <div class="stonex-brand-figure">
...
$widgets_manager->register(new \STONEX_Addons\Widgets\Scalo_Brand_Carousel());
