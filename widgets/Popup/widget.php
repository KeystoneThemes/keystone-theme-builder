...
class STONEX_Popup extends \Elementor\Widget_Base
{
    ...
    {
        return __('Popup', 'stonex');
    }

    public function get_icon()
    {
        return ' stonex eicon-menu-bar';
    }
    ...
    {
        return ['popup', 'video', 'modal', 'stonex'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'stonex_popup_button_icon',
            [
                'label' => __('Open Icon', 'stonex'),
        ...
        $this->add_control(
            'stonex_popup_button_icon_close',
            [
                'label' => __('Close Icon', 'stonex'),
                'type' => Controls_Manager::ICONS,
                'label_block' => true,
                'default' => [
        ...
        $this->add_control(
            'box_bg',
            [
                'label' => __('Box Background', 'stonex'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .stonex-addons-popup-content' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .stonex-addons-popup-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .stonex-addons-popup-content' => 'margin: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .stonex-addons-popup-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .stonex-addons-popup-content' => 'border-radius: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .stonex-addons-popup-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    'body.rtl {{WRAPPER}} .stonex-addons-popup-content' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            'open_icon_bg_color',
            [
                'label' => __('Icon Background Color', 'stonex'),
                'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
            ...
            [
                'label' => __('Hover Icon Background Color', 'stonex'),
                'type' => Controls_Manager::COLOR,
                'default' => $secondary_color,
                'selectors' => [
...
?>
        <div class="stonex-addons-popup-content-wraper">


            <div class="stonex-addons-popup-content">
                <span id="offset-menu-close-btn">
                    <?php Icons_Manager::render_icon($settings['stonex_popup_button_icon_close'], ['aria-hidden' => 'true']); ?>
                </span>
                <?php echo stonex_layout_content($settings['popup_selected_template']); ?>
            </div>

            <div class="stonex-addons-popup">
                <span class="popup-menubar">
                    <?php Icons_Manager::render_icon($settings['stonex_popup_button_icon'], ['aria-hidden' => 'true']); ?>
                </span>
            </div>
...
$widgets_manager->register(new \STONEX\Widgets\Elementor\STONEX_Popup());
