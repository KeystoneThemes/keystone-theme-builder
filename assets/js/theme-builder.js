stonexJsonp([2], {
  ...
  10:
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var _vueColor = __webpack_require__(60);
      ...
      var _stonexMiniToggle = __webpack_require__(8);

      var _stonexMiniToggle2 = _interopRequireDefault(_stonexMiniToggle);
      ...
      exports.default = {
        ...
        components: {
          ...
          toggle: _stonexMiniToggle2.default
        },
        data: function data() {
          return {
            colors: {
        ...
        methods: {
          ...
          removeSolid: function removeSolid(index) {
            this.stonexSettings.backgrounds.solid.splice(index, 1);
          },
          saveToSolid: function saveToSolid() {
            ...
            this.stonexSettings.backgrounds.solid.push(solid);
          },
          ...
          globalCheck: function globalCheck(color) {
            if (color == 'Primary') {
              color = this.stonexSettings.pColor + '';
            } else if (color == 'Secondary') {
              color = this.stonexSettings.sColor + '';
            } else if (color == 'Accent') {
              color = this.stonexSettings.aColor + '';
            } else if (color == 'Headline') {
              color = this.stonexSettings.hColor + '';
            } else if (color == 'Body') {
              color = this.stonexSettings.bColor + '';
            } else if (color == 'Dark Neutral') {
              color = this.stonexSettings.dColor + '';
            } else if (color == 'Light Neutral') {
              color = this.stonexSettings.lColor + '';
            } else if (color == 'White') {
              color = this.stonexSettings.wColor + '';
  ...
  13:
    ...
    (function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_color_vue__ = __webpack_require__(10);
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_color_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_color_vue__);
      /* harmony namespace reexport (unknown) */
      for (var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_color_vue__)
        if (__WEBPACK_IMPORT_KEY__ !== 'default')(function (key) {
          __webpack_require__.d(__webpack_exports__, key, function () {
            return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_color_vue__[key];
          })
        }(__WEBPACK_IMPORT_KEY__));
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_570e8ece_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_color_vue__ = __webpack_require__(63);
      var disposed = false
  ...
  152:
    ...
    (function (module, exports, __webpack_require__) {
      ...
      axios.defaults.headers.common['X-WP-Nonce'] = window.stonex_data.nonce;
      ...
      exports.default = {
        ...
        data: function data() {
          return {
            admin_customizer: window.stonex_data.admin_customizer,
            to_color: window.stonex_data.to_color,
            show: false,
            mode: 'Item',
            type: 'New',
            typeList: ['header', 'footer', 'mega menu', 'Job', 'cs'],
            widthList: ['full', 'container', 'custom'],
            positionList: ['center center', 'center bottom', 'center top', 'bottom right', 'bottom left', 'top right', 'top left'],
        ...
        methods: {
          ...
          edit: function edit(id) {
            var url = window.stonex_data.admin_url + '?post=' + id + '&action=elementor';
            window.location.href = url;
          },
          addHandlers: function addHandlers() {
            var _this = this;
            jQuery('.row-actions .edit a, .page-title-action, body.post-type-stonex-tb a.row-title').on('click', function (s) {
              s.preventDefault();
          ...
          save: function save(callback) {
            ...
            var url = window.stonex_data.wp_json + '/theme-builder/';
          ...
          getEdit: function getEdit() {
            var _this = this;
            var url = window.stonex_data.wp_json + '/theme-builder/' + this.itemId;
        ...
        computed: {
          getMainColor: function getMainColor() {
            var color = '#432CF3'; //to_color
            if (this.admin_customizer === 'true' && this.to_color) {
              color = this.to_color;
            }
            return '--stonex-primary:' + color;
          }
    ...
    (function (module, exports, __webpack_require__) {
      ...
      exports.default = {
        ...
        data: function data() {
          ...
          return {
            positions: Object.values(window.stonex_data.conditions),
        ...
        methods: {
          getSearch: function getSearch(e) {
            var _this = this;
            this.isLoading = true;
            var url = window.stonex_data.wp_json + '/specific-search/';
          ...
          runJqueryCode() {
            var basic_job = jQuery('.basic-job').parent().parent();
            var special_job = jQuery('.special_job').parent().parent();
            basic_job.addClass('basic-job-active');
            jQuery('.edit-job .ash-include-rules .multiselect__element').not(basic_job).not(special_job).hide();

            var basic_cs = jQuery('.basic-cs').parent().parent();
            var special_cs = jQuery('.special_cs').parent().parent();
            basic_cs.addClass('basic-cs-active');
            jQuery('.edit-cs .ash-include-rules .multiselect__element').not(basic_cs).not(special_cs).hide();
          }
        },
        computed: {
          ...
          isJob: function isJob() {
            if (this.value.rule != null) {
              return this.value.rule.value === 'special_job';
            } else {
              return false;
            }
          },
          isCS: function isCS() {
            if (this.value.rule != null) {
              return this.value.rule.value === 'special_cs';
            } else {
              return false;
            }
          },
  ...
  16:
    ...
    (function (module, __webpack_exports__, __webpack_require__) {
      ...
      var render = function () {
        ...
        return _c("div", {
          domProps: {
            innerHTML: _vm._s(__webpack_require__(17)("./icon-" + this.icon + ".svg"))
          },
          on: {
  ...
  17:
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var map = {
        "./icon-admin-customizer.svg": 18,
        "./icon-animations.svg": 19,
        "./icon-blog.svg": 20,
        "./icon-branding.svg": 21,
        "./icon-buttons.svg": 22,
        "./icon-close.svg": 23,
        "./icon-custom.svg": 24,
        "./icon-dark-mode.svg": 25,
        "./icon-dashboard.svg": 26,
        "./icon-demo-loader.svg": 27,
        "./icon-desktop.svg": 28,
        "./icon-documentation.svg": 29,
        "./icon-edit.svg": 30,
        "./icon-feedback.svg": 31,
        "./icon-footer.svg": 32,
        "./icon-general.svg": 33,
        "./icon-global-colors.svg": 34,
        "./icon-global-fonts.svg": 35,
        "./icon-global.svg": 36,
        "./icon-header.svg": 37,
        "./icon-import-preset.svg": 38,
        "./icon-import.svg": 39,
        "./icon-light-mode.svg": 40,
        "./icon-page-title.svg": 41,
        "./icon-performance.svg": 42,
        "./icon-phone.svg": 43,
        "./icon-plugins.svg": 44,
        "./icon-portfolio.svg": 45,
        "./icon-preset.svg": 46,
        "./icon-presetm.svg": 47,
        "./icon-remove-preset.svg": 48,
        "./icon-search.svg": 49,
        "./icon-social.svg": 50,
        "./icon-success.svg": 51,
        "./icon-system.svg": 52,
        "./icon-tablet.svg": 53,
        "./icon-theme-skin.svg": 54,
        "./icon-top-banner.svg": 55,
        "./icon-typography.svg": 56,
        "./icon-updates.svg": 57,
        "./icon-warning.svg": 58,
        "./icon-woo.svg": 59
      };
  ...
  3:
    ...
    (function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_SvgIcon_vue__ = __webpack_require__(9);
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_SvgIcon_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_SvgIcon_vue__);
      /* harmony namespace reexport (unknown) */
      for (var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_SvgIcon_vue__)
        if (__WEBPACK_IMPORT_KEY__ !== 'default')(function (key) {
          __webpack_require__.d(__webpack_exports__, key, function () {
            return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_SvgIcon_vue__[key];
          })
        }(__WEBPACK_IMPORT_KEY__));
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_bd6236d4_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_SvgIcon_vue__ = __webpack_require__(16);
      var disposed = false
      var normalizeComponent = __webpack_require__(0)
      /* script */
  ...
  347:
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var _ThemeBuilder = __webpack_require__(348);
      ...
      var _stonexMultiselect = __webpack_require__(354);

      var _stonexMultiselect2 = _interopRequireDefault(_stonexMultiselect);
      ...
      _vue2.default.component('multiselect', _stonexMultiselect2.default);
  ...
  348:
    ...
    (function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_ThemeBuilder_vue__ = __webpack_require__(152);
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_ThemeBuilder_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_ThemeBuilder_vue__);
      /* harmony namespace reexport (unknown) */
      for (var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_ThemeBuilder_vue__)
        if (__WEBPACK_IMPORT_KEY__ !== 'default')(function (key) {
          __webpack_require__.d(__webpack_exports__, key, function () {
            return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_ThemeBuilder_vue__[key];
          })
        }(__WEBPACK_IMPORT_KEY__));
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_57cbf9ba_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ThemeBuilder_vue__ = __webpack_require__(353);
      var disposed = false
  ...
  350:
    ...
    (function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_rule_vue__ = __webpack_require__(153);
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_rule_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_rule_vue__);
      /* harmony namespace reexport (unknown) */
      for (var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_rule_vue__)
        if (__WEBPACK_IMPORT_KEY__ !== 'default')(function (key) {
          __webpack_require__.d(__webpack_exports__, key, function () {
            return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_rule_vue__[key];
          })
        }(__WEBPACK_IMPORT_KEY__));
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_396a6726_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_rule_vue__ = __webpack_require__(352);
      var disposed = false
        ...
        return _c(
          ...
          [
                ...
                [{
                    ...
                    fn: function (props) {
                      return [
                        ...
                        _c("span", {
                          domProps: {
                            innerHTML: _vm._s(props.option.text)
                          }
                        })
                      ]
                    }
            ...
            _c("multiselect", {
              ...
              model: {
                value: _vm.value.special_job,
                callback: function ($$v) {
                  _vm.$set(_vm.value, "special_job", $$v)
                },
                expression: "value.special_job"
              }
            }) :
            _vm._e(),
            _vm._v(" "),
            ...
            _c("multiselect", {
              ...
              model: {
                value: _vm.value.special_cs,
                callback: function ($$v) {
                  _vm.$set(_vm.value, "special_cs", $$v)
                },
                expression: "value.special_cs"
              }
            }) :
            _vm._e()
  ...
  353:
    ...
    (function (module, __webpack_exports__, __webpack_require__) {
      ...
      var render = function () {
        ...
        return _c(
          "div", {
            staticClass: "stonex_light_scheme stonex_tb",
            ...
            _c(
              ...
              [
                ...
                _c("div", [
                  ...
                  _c("div", {
                    staticClass: "stonex-core-setting"
                  }, [
                    _c("span", {
                      staticClass: "stonex_text"
                    }, [
                      _c("span", {
                        staticClass: "stonex_h2"
                      }, [
                        _vm._v("Type")
                      ]),
                      _vm._v(" "),
                      _c("span", {
                        staticClass: "stonex_p"
                      }, [
                    ...
                    _c(
                      "span", {
                        staticClass: "stonex_set stonex_m"
                      },
                      [
                        _c("multiselect", {
                          class: _vm.itemType,
                          ...
                          model: {
                            ...
                            callback: function ($$v) {
                              ...
                              if ('Job' == $$v || 'cs' == $$v) {
                                ...
                                if ('Job' == $$v) {
                                  basic_job.addClass('basic-job-active');
                                  jQuery('.ash-include-rules .multiselect__element').not(basic_job).not(special_job).hide();
                                  basic_job.show();
                                  special_job.show();
                                }
                                ...
                                if ('cs' == $$v) {
                                  basic_cs.addClass('basic-cs-active');
                                  jQuery('.ash-include-rules .multiselect__element').not(basic_cs).not(special_cs).hide();
                                  basic_cs.show()
                                  special_cs.show()
                                }
                              } else {
                                jQuery('.ash-include-rules .multiselect__element').not(basic_job).not(special_job).show();
                  ...
                  _c("div", {
                    ...
                    _vm._v(" "),
                    _c("span", {
                      staticClass: "stonex_set stonex_l"
                    }, [
                      _c("input", {
                        directives: [{
                          name: "model",
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        "span", {
                          staticClass: "stonex_set",
                          class: _vm.itemWidth === "custom" ? "stonex_m" : "",
                          staticStyle: {
                            display: "flex"
                          }
                        },
                        [
                          ...
                          _c("span", {
                            staticClass: "stonex_s stonex_px"
                          }, [
                            _c("input", {
                              directives: [{
                                name: "model",
                  ...
                  _c(
                    "div", {
                      ...
                      staticClass: "stonex-bt-fix sub-wrapper"
                    },
                    [
                      _c("div", {
                        staticClass: "stonex-core-setting"
                        ...
                        _c(
                          "span", {
                            staticClass: "stonex_set",
                            class: _vm.popupSettings.width.mode === "custom" ?
                              "stonex_m" : "",
                            staticStyle: {
                              display: "flex"
                            }
                      ...
                      _c("div", {
                        ...
                        _c(
                          "span", {
                            staticClass: "stonex_set",
                            class: _vm.popupSettings.height.mode === "custom" ?
                              "stonex_m" : "",
                            staticStyle: {
                              display: "flex"
                            }
                        ...
                        [
                          ...
                          _c(
                            ...
                            [
                              ...
                              _c(
                                "small", {
                                  staticClass: "stonex-colors-label"
                                },
                                [_vm._v("Main Color")]
                              ),
                              _vm._v(" "),
                  ...
                  _vm.itemType != "" ?
                  _c("div", {
                    staticClass: "stonex-small-separator"
                  }, [
                    ...
                    "div", {
                      directives: [{
                        ...
                        value: _vm.itemType != "mega menu" &&
                          _vm.itemType != "block" &&
                          _vm.itemType != "",
                        expression: "itemType != 'mega menu' && itemType != 'block' && itemType != ''"
                      }],
                      staticClass: "stonex-core-setting stonex-sub stonex-no-margin"
                    },
                    [
                      _c("span", {
                        staticClass: "stonex_text"
                  ...
                  _c(
                    "div", {
                      staticClass: "stonex-core-setting stonex-sub"
                    },
                    [
                      _c("span", {
                        staticClass: "stonex_text"
                  ...
                  _c("div", {
                    staticClass: "ui-condition-action"
                  }, [
                    _c(
                      "span", {
                        directives: [{
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c(
                            "span", {
                              staticClass: "stonex_set ui-multiple"
                            },
                            [
                              _c("toggle", {
                                attrs: {
                                ...
                                model: {
                                  value: _vm.popupSettings.trigger.pageLoad.enable,
                                  callback: function ($$v) {
                                    _vm.$set(
                                  ...
                                  expression: "popupSettings.trigger.pageLoad.enable"
                                }
                              }),
                              _vm._v(" "),
                                ...
                                _c("div", {
                                  ...
                                  _c("input", {
                                    directives: [{
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.popupSettings.trigger.pageLoad
                                        .delay,
                                      expression: "popupSettings.trigger.pageLoad.delay"
                                    }],
                                    staticClass: "stonex_s",
                                    attrs: {
                                      min: 1,
                          ...
                          _c(
                            ...
                            [
                              _c("toggle", {
                                ...
                                model: {
                                  value: _vm.popupSettings.trigger.pageScroll.enable,
                                  callback: function ($$v) {
                                    _vm.$set(
                                  ...
                                  expression: "popupSettings.trigger.pageScroll.enable"
                                }
                              }),
                              _vm._v(" "),
                                    ...
                                    _c(
                                      ...
                                      [
                                        _c("multiselect", {
                                          ...
                                          model: {
                                            value: _vm.popupSettings.trigger
                                            ...
                                            expression: "popupSettings.trigger.pageScroll.direction"
                                          }
                                        })
                                      ],
                                      1
                                        ...
                                        [
                                          _c("input", {
                                            directives: [{
                                              name: "model",
                                              rawName: "v-model",
                                              value: _vm.popupSettings
                                                .trigger.pageScroll
                                                .amount,
                                              expression: "popupSettings.trigger.pageScroll.amount"
                                            }],
                                            staticClass: "stonex_s",
                                            attrs: {
                                              min: 1,
                          ...
                          _c(
                            ...
                            [
                              _c("toggle", {
                                ...
                                model: {
                                  value: _vm.popupSettings.trigger.scrollToElement
                                    .enable,
                                  callback: function ($$v) {
                                    _vm.$set(
                                  ...
                                  expression: "popupSettings.trigger.scrollToElement.enable"
                                }
                              }),
                              _vm._v(" "),
                                ...
                                _c("div", {
                                  ...
                                  _c("input", {
                                    directives: [{
                                      ...
                                      expression: "popupSettings.trigger.scrollToElement.selector"
                                    }],
                                    staticClass: "stonex_m",
                                    domProps: {
                                      value: _vm.popupSettings.trigger
                                ...
                                _c("div", {
                                  ...
                                  _c("input", {
                                    directives: [{
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.popupSettings.trigger.click
                                        .clicks,
                                      expression: "popupSettings.trigger.click.clicks"
                                    }],
                                    staticClass: "stonex_s",
                                    attrs: {
                                      min: 1,
                                    ...
                                    domProps: {
                                      value: _vm.popupSettings.trigger.click.clicks
                                    },
                                    on: {
                                      input: function ($event) {
                                        if ($event.target.composing) {
                          ...
                          _c(
                            ...
                            [
                              _c("toggle", {
                                ...
                                model: {
                                  value: _vm.popupSettings.trigger.clickOnElement
                                    .enable,
                                  callback: function ($$v) {
                                    _vm.$set(
                                  ...
                                  expression: "popupSettings.trigger.clickOnElement.enable"
                                }
                              }),
                              _vm._v(" "),
                                ...
                                _c("div", {
                                  ...
                                  _c("input", {
                                    directives: [{
                                      ...
                                      expression: "popupSettings.trigger.clickOnElement.selector"
                                    }],
                                    staticClass: "stonex_m",
                                    attrs: {
                                      min: 50,
                            ...
                            [
                              _c("toggle", {
                                ...
                                model: {
                                  ...
                                  expression: "popupSettings.trigger.onExit.enable"
                                }
                              })
                            ],
                            1
                            ...
                            [
                              _c("toggle", {
                                ...
                                model: {
                                  ...
                                  expression: "popupSettings.trigger.maxShow.enable"
                                }
                              }),
                              _vm._v(" "),
                                ...
                                _c("div", {
                                  ...
                                  _c("input", {
                                    directives: [{
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.popupSettings.trigger.maxShow
                                        .amount,
                                      expression: "popupSettings.trigger.maxShow.amount"
                                    }],
                                    staticClass: "stonex_s",
                                    attrs: {
                                      min: 1,
  ...
  354:
    ...
    (function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stonexMultiselect_vue__ = __webpack_require__(154);
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stonexMultiselect_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stonexMultiselect_vue__);
      /* harmony namespace reexport (unknown) */
      for (var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stonexMultiselect_vue__)
        if (__WEBPACK_IMPORT_KEY__ !== 'default')(function (key) {
          __webpack_require__.d(__webpack_exports__, key, function () {
            return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stonexMultiselect_vue__[key];
          })
        }(__WEBPACK_IMPORT_KEY__));
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3acb0aa1_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_stonexMultiselect_vue__ = __webpack_require__(355);
      var disposed = false
      var normalizeComponent = __webpack_require__(0)
      /* script */
      ...
      var __vue_module_identifier__ = null
      var Component = normalizeComponent(
        __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stonexMultiselect_vue___default.a,
        __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3acb0aa1_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_stonexMultiselect_vue__["a" /* default */ ],
        __vue_template_functional__,
        __vue_styles__,
        __vue_scopeId__,
        __vue_module_identifier__
      )
      Component.options.__file = "assets/src/theme-builder/stonexMultiselect.vue"
    ...
    (function (module, __webpack_exports__, __webpack_require__) {
      ...
      var render = function () {
        ...
        return _c(
          "div", {
            ref: "colorpicker",
            staticClass: "stonex-color-picker stonex-popup-holder stonex_m",
          ...
          [
            ...
            _c(
              "div", {
                staticClass: "stonex-type stonex-solid",
                on: {
                  click: function ($event) {
              ...
              [
                ...
                _c(
                  "div", {
                    staticClass: "stonex-global-item",
                    attrs: {
                      title: "Change this Global Color"
                    },
                    on: {
                      click: _vm.goToGlobal
                    }
                  },
                  [
                    _c("svg-icon", {
                      staticClass: "stonex-svg",
                      attrs: {
                        icon: "global"
                      }
                    })
            ...
            !_vm.mini ?
            _c("span", {
              staticClass: "stonex-current-color",
              style: _vm.style,
              on: {
                click: function ($event) {
                  return _vm.togglePicker()
            ...
            _vm.displayPicker ?
            _c("div", {
              staticClass: "stonex-popup"
            }, [
              _c(
                "div", {
                  staticClass: "stonex-color-wrapp"
                },
                [
  ...
  64:
    ...
    (function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Popup_vue__ = __webpack_require__(12);
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Popup_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Popup_vue__);
      /* harmony namespace reexport (unknown) */
      for (var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Popup_vue__)
        if (__WEBPACK_IMPORT_KEY__ !== 'default')(function (key) {
          __webpack_require__.d(__webpack_exports__, key, function () {
            return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Popup_vue__[key];
          })
        }(__WEBPACK_IMPORT_KEY__));
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_de6b95f6_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Popup_vue__ = __webpack_require__(66);
      var disposed = false
  ...
  66:
    ...
    (function (module, __webpack_exports__, __webpack_require__) {
      ...
      var render = function () {
        ...
        var _h = _vm.$createElement
        var _c = _vm._self._c || _h
        var type_class = _vm.title.replace(/ /g, "-").toLowerCase();

        type_class = 'new-job' == type_class ? 'edit-job' : type_class;
        type_class = 'new-cs' == type_class ? 'edit-cs' : type_class;
        jQuery('.stonex_tb').addClass(type_class);

        var basic_job = jQuery('.edit-job .basic-job').parent().parent();
        var special_job = jQuery('.edit-job .special_job').parent().parent();

        basic_job.addClass('basic-job-active');
        jQuery('.edit-job .ash-include-rules .multiselect__element').not(basic_job).not(special_job).hide();

        var basic_cs = jQuery('.edit-cs .basic-cs').parent().parent();
        var special_cs = jQuery('.edit-cs .special_cs').parent().parent();

        basic_cs.addClass('basic-cs-active');
        jQuery('.edit-cs .ash-include-rules .multiselect__element').not(basic_cs).not(special_cs).hide();

        return _c("div", {
          staticClass: "stonex_light_scheme "
        }, [
          _c("div", {
            staticClass: "ui-modal-backdrop",
            on: {
              click: _vm.close
            }
          }),
          ...
          _c("div", {
            ...
            _c(
              ...
              [
                _c("div", {
                  staticClass: "ui-modal-head"
                }, [
                  _c("span", {
                    staticClass: "stonex_h1 "
                  }, [
                ...
                _c("div", {
                  ...
                  _vm.btn1 ?
                  _c("div", {
                    class: ["stonex-btn", "stonex-btn-m", _vm.btn1.class],
                    domProps: {
                      innerHTML: _vm._s(_vm.btn1.text)
                    },
                    on: {
                      click: function ($event) {
                  ...
                  _vm.btn2 ?
                  _c("div", {
                    class: ["stonex-btn", "stonex-btn-m", _vm.btn2.class],
                    domProps: {
                      innerHTML: _vm._s(_vm.btn2.text)
                    },
                    on: {
                      click: function ($event) {
  ...
  68:
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var _vuexRestApi = __webpack_require__(70);
      ...
      var uRl = stonex_data.root;
      var wpNonce = stonex_data.nonce;

      var stonexSettings = new _vuexRestApi2.default({
        baseURL: '', //uRl + '/?rest_route=/',
        state: {
          stonexSettings: window.stonex_data.settings,
          errorLog: window.stonex_data.importlog,
          fonts: {
            fam: [],
            variants: []
          }
        ...
        action: 'getBsettings',
        property: 'stonexSettings',
        path: uRl + '/?rest_route=/stonex/v1/settings',
        headers: {
          'X-WP-Nonce': wpNonce
        }
      }).get({
        action: 'getFonts',
        property: 'fonts',
        path: window.stonex_data.stonex_assets_path + '/fonts/fonts.json',
        headers: {
          'X-WP-Nonce': wpNonce
        },
        onSuccess: function onSuccess(state, payload, axios, _ref) {
          ...
          var customFonts = window.stonex_temp_customFonts ? window.stonex_temp_customFonts : false;
          if (customFonts && Object.keys(customFonts).length != 0) {
            state.fonts.fam.push(customFonts);
          }

          //add stonex Typekit Fonts
          var typekit_fonts = window.stonex_data.typekit_fonts ? window.stonex_data.typekit_fonts : false;
          if (typekit_fonts && Object.keys(typekit_fonts).length != 0) {
            state.fonts.fam.push(typekit_fonts);
          }

          //add Custom Fonts
          var custom_fonts = window.stonex_data.custom_fonts ? window.stonex_data.custom_fonts : false;
          if (custom_fonts && Object.keys(custom_fonts).length != 0) {
            state.fonts.fam.push(custom_fonts);
          }

          //add Elementor Typekit Fonts
          var elementor_typekit_fonts = window.stonex_data.elementor_typekit_fonts ? window.stonex_data.elementor_typekit_fonts : false;
          ...
          var elementor_custom_fonts = window.stonex_data.elementor_custom_fonts ? window.stonex_data.elementor_custom_fonts : false;
      ...
      var store = new _vuex2.default.Store(_extends({}, stonexSettings));
  ...
  8:
    ...
    (function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stonex_mini_toggle_vue__ = __webpack_require__(11);
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stonex_mini_toggle_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stonex_mini_toggle_vue__);
      /* harmony namespace reexport (unknown) */
      for (var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stonex_mini_toggle_vue__)
        if (__WEBPACK_IMPORT_KEY__ !== 'default')(function (key) {
          __webpack_require__.d(__webpack_exports__, key, function () {
            return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stonex_mini_toggle_vue__[key];
          })
        }(__WEBPACK_IMPORT_KEY__));
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_33203615_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_stonex_mini_toggle_vue__ = __webpack_require__(62);
      var disposed = false
      ...
      var __vue_module_identifier__ = null
      var Component = normalizeComponent(
        __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_stonex_mini_toggle_vue___default.a,
        __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_33203615_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_stonex_mini_toggle_vue__["a" /* default */ ],
        __vue_template_functional__,
        __vue_styles__,
        __vue_scopeId__,
        __vue_module_identifier__
      )
      Component.options.__file = "assets/src/admin/utils/settings/stonex-mini-toggle.vue"
