<?php
namespace STONEX\Elementor\ThemeBuilder\Widgets;
...
use STONEX\Elementor\ThemeBuilder\Common;
...
class TheContent extends Widget_Base
{
    public function get_name() {
		return 'stonex-the-content';
	}

	public function get_title() {
		return esc_html__( 'Post Content', 'stonex' );
	}
	...
	public function get_categories() {
		return [ 'uicore', 'stonex-theme-builder' ];
	}
	...
	// 	   $id = $post->ID;
	//    }
    //     echo $elementor_instance->frontend->get_builder_content_for_display( $id, true );
