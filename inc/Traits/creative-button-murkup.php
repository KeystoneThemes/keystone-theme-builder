...
trait Button_Markup {
    ...
    public function render_estilo_markup($settings) {
        $this->add_render_attribute( 'wrap', 'class', 'stonex-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'stonex-creative-btn', 'stonex-stl--' . $settings['btn_style'], 'stonex-eft--' .$settings['estilo_effect'] ] );
...
EOF;
    ...
    public function render_symbolab_markup($settings){
        $this->add_render_attribute( 'wrap', 'class', 'stonex-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'stonex-creative-btn', 'stonex-stl--' . $settings['btn_style'], 'stonex-eft--' .$settings['symbolab_effect'] ] );
		...
		$btn_attr = $this->get_render_attribute_string( 'button' );
		$btn_txt = $settings['button_text'];
		$icon = $settings['icon']['value'] ? $settings['icon']['value'] : 'fas fa-arrow-right';
...
EOF;
    ...
    public function render_iconica_markup($settings){
		$this->add_render_attribute( 'wrap', 'class', 'stonex-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'stonex-creative-btn', 'stonex-stl--' . $settings['btn_style'], 'stonex-eft--' .$settings['iconica_effect'] ] );
...
EOF;
    ...
    public function render_montino_markup($settings){
		$this->add_render_attribute( 'wrap', 'class', 'stonex-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'stonex-creative-btn', 'stonex-stl--' . $settings['btn_style'], 'stonex-eft--' .$settings['montino_effect'] ] );
        $this->add_link_attributes( 'button', $settings['button_link'] );
...
EOF;
    ...
    public function render_hermosa_markup($settings){
		$this->add_render_attribute( 'wrap', 'class', 'stonex-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'stonex-creative-btn', 'stonex-stl--' . $settings['btn_style'], 'stonex-eft--' .$settings['hermosa_effect'] ] );
        $this->add_link_attributes( 'button', $settings['button_link'] );
